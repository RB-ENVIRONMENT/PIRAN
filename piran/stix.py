...
class Stix:
    ...
    @u.quantity_input
    def R(self, omega: u.Hz) -> u.dimensionless_unscaled:
    ...
    @u.quantity_input
    def L(self, omega: u.Hz) -> u.dimensionless_unscaled:
        if not omega.isscalar:
            raise ValueError("Frequency omega should be a scalar")
    ...
    @u.quantity_input
    def P(self, omega: u.Hz) -> u.dimensionless_unscaled:
        if not omega.isscalar:
            raise ValueError("Frequency omega should be a scalar")
    ...
    @u.quantity_input
    def S(self, omega: u.Hz) -> u.dimensionless_unscaled:
        return (self.R(omega) + self.L(omega)) / 2

    @u.quantity_input
    def D(self, omega: u.Hz) -> u.dimensionless_unscaled:
        return (self.R(omega) - self.L(omega)) / 2

    @u.quantity_input
    def dR(self, omega: u.Hz) -> u.s:
        if not omega.isscalar:
            raise ValueError("Frequency omega should be a scalar")
    ...
    @u.quantity_input
    def dS(self, omega: u.Hz) -> u.s:
        return (self.dR(omega) + self.dL(omega)) / 2

    @u.quantity_input
    def dD(self, omega: u.Hz) -> u.s:
        return (self.dR(omega) - self.dL(omega)) / 2

    @u.quantity_input
    def A(self, omega: u.Hz, X: u.dimensionless_unscaled) -> u.dimensionless_unscaled:
    ...
    @u.quantity_input
    def dA(self, omega: u.Hz, X: u.dimensionless_unscaled) -> u.s:
    ...
    @u.quantity_input
    def dC(self, omega: u.Hz, X: u.dimensionless_unscaled) -> u.s:
        return (
    ...
    @u.quantity_input
    def jacobian(
        self, omega: u.Hz, X: u.dimensionless_unscaled, k: u.Quantity[1 / u.m]
